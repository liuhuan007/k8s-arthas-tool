...
function getActionClass(action) {
    const map = {
        ...
        'logout': 'bg-logout',
        'connection_created': 'bg-connect',
        'connection_deleted': 'bg-connect',
        'user_created': 'bg-create',
        'user_updated': 'bg-create',
        'user_deleted': 'bg-delete',
        'user_status_changed': 'bg-create',
        'change_password': 'bg-create',
        'task_created': 'bg-create',
        'task_cancelled': 'bg-delete',
        'file_downloaded': 'bg-download',
        'ai_config_saved': 'bg-create',
        'ai_arthas_exec': 'bg-connect',
        'mcp_token_created': 'bg-create',
        'mcp_token_deleted': 'bg-delete',
...
function getActionText(action) {
    const map = {
        ...
        'ai_config_saved': '保存AI配置',
        'ai_arthas_exec': 'AI执行命令',
        'mcp_token_created': '创建MCP Token',
        'mcp_token_deleted': '删除MCP Token',
        'cluster_assign': '分配集群'
    };
